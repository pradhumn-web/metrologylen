...
export default function Home() {
  ...
  return (
    <div className="metrology-page">
      ...
      <nav className="mobile-app-nav" aria-label="App navigation"><a href="#console"><span>⌾</span><small>Scan</small></a><a href="#metrology-checklist"><span>☑</span><small>Rules</small></a><a href="#verdicts"><span>◈</span><small>Verdicts</small></a><a href="#allergens"><span>◇</span><small>Health</small></a><a href="#api"><span>≡</span><small>API</small></a></nav>
    </div>
  );
}
