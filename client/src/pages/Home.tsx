...
export default function Home() {
  ...
  const captureCount = scanState === "done" ? 3 : capturedFrames.length;
  const scanStage = scanState === "done" ? "Scan complete · review your 10-rule verdict" : captureCount === 0 ? "Start with the front package panel" : captureCount === 1 ? "Now capture the ingredients panel" : "Now capture the barcode or batch panel";
    ...
    <div className="metrology-page">
      ...
      <main className="document-shell">
        ...
        <section className="hero-section" id="top">
          <div className="hero-copy"><p className="section-kicker">A field instrument for printed truth</p><h1>Read the label.<br /><em>Measure the claim.</em></h1><p className="hero-lede">Scan a package to extract the declarations that matter: quantity, MRP, dates, consumer care, barcode, ingredients, allergens and health signals.</p><p className="citation">PRIMARY WORKFLOW · 3 PANEL CAPTURE · 10 METROLOGY RULES</p><div className="hero-actions"><button className="button button-dark" onClick={openCamera}>Start package scan <span>↗</span></button><a className="button button-line" href="#metrology-checklist">View 10 rules</a></div></div>
